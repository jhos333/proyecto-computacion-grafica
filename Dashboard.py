...
def checkFile():
	...
	if(checkfile==True):
		...
		content="no hay contenido disponible aún"
	return content
...
class Dashboard(QtWidgets.QMainWindow):
	def __init__(self):
		...
		self.title = 'Reconocimiento de Lenguaje de Señas'
	...
	def createGest(self):
		...
		try:
			...
			pass
		self.exit_button.clicked.connect(self.quitApplication)
		self.plainTextEdit.setPlaceholderText("Ingresar el nobmre del gesto aquí")
		img_text = ''
		saveimg=[]
		while True:
